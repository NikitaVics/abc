                            ...
                            SizedBox(
                              ...
                              child: GridView.builder(
                                  ...
                                  itemBuilder: (BuildContext context, int index) {
                                      String containImage = index % 2 == 0 ? "assets/images/Shape33.png" : "assets/images/Shape34.png";
                                    return Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            Padding(
                                            padding: EdgeInsets.only(left: 7.01,top: 6.79),
                                            child: Text("Court $index",
                                             style: TextStyle(
                              color:
                                  Theme.of(context).brightness == Brightness.dark
                                    ? AppColors.booklight
                       ...
                       style: TextStyle(
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.only(top: 24,left: 23.37,right: 23.37),
                                    child: Row(
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.only(top: 16,left: 23.37,right: 23.37),
                                    child: Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                  ...
                                  Padding(
                                    ...
                                    child:Container(
                                      ...
                                      child: SingleChildScrollView(
                                        child: Text("Lorem ipsum dolor sit amet consectetur. Amet posuere cursus habitant vitae fermentum non lectus. Lectus at felis amet dui morbi",
                                          style: TextStyle(
                                      color:
                                          Theme.of(context).brightness == Brightness.dark
                                            ? AppColors.booklight
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.only(top: 19,left: 23,bottom: 24,right: 22),
                                    child: Row(
                                      children: [
                                        Expanded(
                                          child: SizedBox(
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: Image.asset("assets/images/Shape33.png"))),
                                        ),
                                            SizedBox(width: 15,),
                                         Expanded(
                                           child: SizedBox(
                                            ...
                                            child: ClipRRect(
                                               borderRadius: BorderRadius.circular(7),
                                              child: Image.asset("assets/images/Shape34.png"))),
                                         ),
                                      ],
                                    ),
                                  ),

      ...
      child: Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
            items: <BottomNavigationBarItem>[
              ...
              /*InkWell(
              onTap: () async {
                context.read<IndexProvider>().updateCurrentIndex(0);
                Navigator.push(
                  context,
                  PageTransition(
                    ...
                    child: const DashboardUserScreen(),
                  ),
                );
              },
              child: NavBarItem(
                NavBarIcon: context.watch<IndexProvider>().currentIndex == 0
                    ? Image.asset(
            ...
            InkWell(
              ...
              child: NavBarItem(
                NavBarIcon: context.watch<IndexProvider>().currentIndex == 1
                    ? Image.asset(
            ...
            InkWell(
              onTap: () async {
                context.read<IndexProvider>().updateCurrentIndex(2);
                Navigator.push(
                  context,
                  PageTransition(
                    duration: const Duration(milliseconds: 400),
              ...
              child: NavBarItem(
                NavBarIcon: context.watch<IndexProvider>().currentIndex == 2
                    ? Image.asset(
                  'assets/images/TTD.png',
                  width: 25, // Set the width of the icon image
                  height: 25,
                )
                    : Image.asset(
            ...
            InkWell(
              onTap: () async {
                context.read<IndexProvider>().updateCurrentIndex(3);
                Navigator.push(
                  context,
                  PageTransition(
                    duration: const Duration(milliseconds: 400),
              ...
              child: NavBarItem(
                NavBarIcon: context.watch<IndexProvider>().currentIndex == 3
                    ? Image.asset(
